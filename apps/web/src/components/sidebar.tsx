...
export function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-[#090d16] text-slate-200 border-r border-[#1e293b]">
      {/* ── Brand Header ─────────────────────────────────── */}
      <div className="h-16 flex items-center justify-between px-5 border-b border-[#1e293b] flex-shrink-0">
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-[10px] font-mono uppercase tracking-wider text-sky-400 font-semibold">
              Medical ERP &amp; POS
            </p>
          </div>
        </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-slate-800/90 text-sky-400 font-semibold border-l-2 border-sky-400 pl-2.5'
            ...
            >
              ...
              {item.highlight && (
                <span className="ml-auto text-[9px] px-1.5 py-0.5 rounded font-mono font-bold bg-sky-500/20 text-sky-300 border border-sky-500/30">
                  POS
                </span>
              )}
            </Link>
      ...
      {/* ── Footer User Tag ───────────────────────────────── */}
      <div className="p-3 border-t border-[#1e293b] flex items-center gap-3">
