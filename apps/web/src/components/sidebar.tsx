...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Stock Transfers', href: '/stock-transfers', icon: RotateCcw, permission: 'inventory.adjust' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Branches', href: '/super-admin/branches', icon: Building2, permission: 'super_admin.access' },
