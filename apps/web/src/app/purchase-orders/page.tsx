                  ...
                  {isLoading ? (
                    ...
                    purchaseOrders.map((po: any) => (
                      <tr key={po.id} className="hover:bg-slate-50 transition">
                        <td className="py-3 px-4 font-bold font-mono text-slate-900">{po.poNumber}</td>
                        <td className="py-3 px-4 text-slate-600">{formatDate(po.createdAt)}</td>
                        <td className="py-3 px-4 font-semibold text-slate-800">{po.supplier?.name || '—'}</td>
