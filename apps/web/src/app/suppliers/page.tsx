      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white tracking-tight">Suppliers &amp; Distributors</h2>
                {canManage ? (
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {isLoading ? (
                    ...
                    <tr key={sup.id} className="hover:bg-slate-800/40 transition">
                      <td className="py-3 px-4 font-bold text-white">{sup.name}</td>
        ...
        {showModal && canManage && (
          <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-[#0f172a] rounded-2xl border border-slate-700 max-w-xl w-full p-6 space-y-4 text-xs overflow-y-auto max-h-[90vh]">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block font-semibold text-slate-300 mb-1">Drug License Number</label>
                    <input
                      type="text"
